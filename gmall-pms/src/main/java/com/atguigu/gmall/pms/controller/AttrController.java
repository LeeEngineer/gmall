...
public class AttrController {
    ...
    @ApiOperation("查询分类下的属性")
    @GetMapping("/category/{cid}")
    public ResponseVo<List<AttrEntity>> getAttrByCategoryId(@PathVariable("cid")String categoryId,
            @RequestParam(value = "type",required = false)Integer type,
            @RequestParam(value = "searchType",required = false)Integer searchType ){

        List<AttrEntity> attrEntities = attrService.getAttrByCategoryId(categoryId,type,searchType);
    ...
    public ResponseVo<List<AttrEntity>> getAttrByGroupId(@PathVariable("gid") Long groupId){
